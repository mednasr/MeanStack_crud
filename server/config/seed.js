...
Country.find(function (err, data) {
  if (data.length < 1) {
    Country.create({"name": "Afghanistan", "dial_code": "+93", "code": "AF"}, {
      "name": "Albania",
      "dial_code": "+355",
      "code": "AL"
      ...
      "dial_code": "+263",
      "code": "ZW"
    }, {"name": "Aland Islands", "dial_code": "+358", "code": "AX"}, function () {
